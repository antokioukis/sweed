...
*/
	...
	/* fprintf(fp,"\tReleased:\t\tOctober 2017.betaVersion.\nAccepting '.' as the only input in the GT\n\n\n"); */
	/* fprintf(fp, "\tComment:\t\tCorrects some bugs on handling the outgroup\n\n"); */
	/* fprintf(fp,"\n\n"); */

	fprintf(fp,"\n\n");
	fprintf(fp,"\tVersion:\t\t3.4\n\n");
	fprintf(fp,"\tReleased:\t\tJanuary 2018.betaVersion.\nAccepting a list of candidate locations\n\n");
	fprintf(fp,"\n\n");
...
void printHelp (FILE * fp)
{
	...
	fprintf(fp, "\t-gridFile\t\tA file with the candidate locations (with VCF).\n\n");
	fprintf(fp,"\n\n");
}
...
{
  int i, j=0, jj = 0, index=0, start=0, end=0, len = strlen(string);
